  ...
  const handleSaveBudget = async (budgetData) => {
    try {
      ...
      if (editingBudget) {
        ...
        response = await fetch(`/api/budgets/${editingBudget._id}`, {
          method: 'PUT',
          headers: {
      ...
      // Refresh the budgets list and reset editing state
      fetchData();
    ...
    <div className="min-h-screen bg-gray-100">
      <div className="container mx-auto py-8 px-4">
        <div className="flex justify-between items-center mb-6">
          ...
          <TestDataButton onDataAdded={fetchData} />
        </div>
